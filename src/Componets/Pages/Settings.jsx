...
function Settings() {
  ...
  useEffect(() => {
    ...
    if (u) {
      ...
      setPreview(u.profile?.profileImage && u.profile?.profileImage.startsWith('http') ? u.profile?.profileImage : (u.profile?.profileImage ? `http://localhost:5002${u.profile?.profileImage}` : "http://localhost:5173/src/assets/images/admin-usr.png"));
    }
  }, []);
      ...
      if (e.key === 'user' || e.key === null) {
        ...
        if (userData) {
          ...
          if (userData.profile?.profileImage) {
            const imageUrl = userData.profile?.profileImage.startsWith('http') ? userData.profile?.profileImage : (userData.profile?.profileImage ? `http://localhost:5002${userData.profile?.profileImage}` : "http://localhost:5173/src/assets/images/admin-usr.png");
    ...
    try {
      ...
      if (refreshed.success) {
        ...
        if (updatedUser.profile?.profileImage) {
          const imageUrl = updatedUser.profile?.profileImage.startsWith('http') ? updatedUser.profile?.profileImage : (updatedUser.profile?.profileImage ? `http://localhost:5002${updatedUser.profile?.profileImage}` : "http://localhost:5173/src/assets/images/admin-usr.png");
